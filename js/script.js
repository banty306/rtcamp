    ...
    function fetchUserInfo() {
        $.ajax({
            ...
            success: function(results) {
                ...
                for (i = 0; i < length; i++) {
                    if (i == 0) {
                        list += '<div class="item active" style="height:100px"><br /><b>'+ results.user_name[i].text +'<br/><br/>' + results.tweets[i].text + '</b></div>';
                    } else {
                        list += '<div class="item" style="height:100px"><br /><b>'+ results.user_name[i].text +'<br/><br/>' + results.tweets[i].text + '</b></div>';
                    }
